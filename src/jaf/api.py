...
# `from my_test_project.jaf import jaf`,
...
def jaf_api(n: int, loglevel: int ):
    ...
    print("The {}-th Fibonacci number is {}".format(n, jaf(n)))
    _logger.info("Script ends here")


def jaf(n):
    """jaf provides a Fibonacci example function
